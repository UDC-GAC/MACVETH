...
#pragma macveth n 8 c 1 h 1 w 8
  int n;
  ...
  for (n = 0; (n + 8) <= num_output; n += 8) {
    ...
    for (c = 0; (c + 1) <= channel; c += 1) {
      ...
      for (h = 0; (h + 1) <= height; h += 1) {
        ...
        for (w = 0; (w + 8) <= width; w += 8) {
          ...
          __mv_vop3 = _mm256_loadu_ps(
              &weights[(n + 1)][(c + 0)][(h + 0)][(w + 0)]); // latency = 1
          __mv_vop5 = _mm256_loadu_ps(
              &weights[(n + 2)][(c + 0)][(h + 0)][(w + 0)]); // latency = 1
          __mv_vop7 = _mm256_loadu_ps(
              &weights[(n + 3)][(c + 0)][(h + 0)][(w + 0)]); // latency = 1
          __mv_vop9 = _mm256_loadu_ps(
              &weights[(n + 4)][(c + 0)][(h + 0)][(w + 0)]); // latency = 1
          __mv_vop11 = _mm256_loadu_ps(
              &weights[(n + 5)][(c + 0)][(h + 0)][(w + 0)]); // latency = 1
          __mv_vop13 = _mm256_loadu_ps(
              &weights[(n + 6)][(c + 0)][(h + 0)][(w + 0)]); // latency = 1
          __mv_vop15 = _mm256_loadu_ps(
              &weights[(n + 7)][(c + 0)][(h + 0)][(w + 0)]); // latency = 1
          __mv_accm0 =
              _mm256_fmadd_ps(__mv_vop0, __mv_vop1, __mv_accm0); // latency = 5
          __mv_accm0 =
              _mm256_fmadd_ps(__mv_vop3, __mv_vop1, __mv_accm0); // latency = 5
          __mv_accm0 =
              _mm256_fmadd_ps(__mv_vop5, __mv_vop1, __mv_accm0); // latency = 5
          __mv_accm0 =
              _mm256_fmadd_ps(__mv_vop7, __mv_vop1, __mv_accm0); // latency = 5
          __mv_accm0 =
              _mm256_fmadd_ps(__mv_vop9, __mv_vop1, __mv_accm0); // latency = 5
          __mv_accm0 =
              _mm256_fmadd_ps(__mv_vop11, __mv_vop1, __mv_accm0); // latency = 5
          __mv_accm0 =
              _mm256_fmadd_ps(__mv_vop13, __mv_vop1, __mv_accm0); // latency = 5
          __mv_accm0 =
              _mm256_fmadd_ps(__mv_vop15, __mv_vop1, __mv_accm0); // latency = 5
    ...
    __mv_vop17 = _mm256_loadu_ps(&top[(n + 0)]);        // latency = 1
    __mv_vop18 = _mm256_loadu_ps(&bias[(n + 0)]);       // latency = 1
    __mv_vop17 = _mm256_add_ps(__mv_vop17, __mv_vop18); // latency = 4
    _mm256_storeu_ps(&top[(n + 0)], __mv_vop17);        // latency = 1
    // vectorized: top[n] = top[n] + bias[n];
  }
...
#pragma macveth n 8 c 8
  ...
  for (n = 0; (n + 8) <= num_output; n += 8) {
    ...
    __mv_accm0 =
        _mm256_set_ps(0, 0, 0, 0, 0, 0, 0, top[(n + 0)]); // latency = 1
    __mv_accm1 =
        _mm256_set_ps(0, 0, 0, 0, 0, 0, 0, top[(n + 1)]); // latency = 1
    __mv_accm2 =
        _mm256_set_ps(0, 0, 0, 0, 0, 0, 0, top[(n + 2)]); // latency = 1
    __mv_accm3 =
        _mm256_set_ps(0, 0, 0, 0, 0, 0, 0, top[(n + 3)]); // latency = 1
    __mv_accm4 =
        _mm256_set_ps(0, 0, 0, 0, 0, 0, 0, top[(n + 4)]); // latency = 1
    __mv_accm5 =
        _mm256_set_ps(0, 0, 0, 0, 0, 0, 0, top[(n + 5)]); // latency = 1
    __mv_accm6 =
        _mm256_set_ps(0, 0, 0, 0, 0, 0, 0, top[(n + 6)]); // latency = 1
    __mv_accm7 =
        _mm256_set_ps(0, 0, 0, 0, 0, 0, 0, top[(n + 7)]); // latency = 1
    for (c = 0; (c + 8) <= channel; c += 8) {
      __mv_vop0 = _mm256_loadu_ps(&weights[(n + 0)][(c + 0)]);  // latency = 1
      __mv_vop1 = _mm256_loadu_ps(&bottom[(c + 0)]);            // latency = 1
      __mv_vop3 = _mm256_loadu_ps(&weights[(n + 1)][(c + 0)]);  // latency = 1
      __mv_vop5 = _mm256_loadu_ps(&weights[(n + 2)][(c + 0)]);  // latency = 1
      __mv_vop7 = _mm256_loadu_ps(&weights[(n + 3)][(c + 0)]);  // latency = 1
      __mv_vop9 = _mm256_loadu_ps(&weights[(n + 4)][(c + 0)]);  // latency = 1
      __mv_vop11 = _mm256_loadu_ps(&weights[(n + 5)][(c + 0)]); // latency = 1
      __mv_vop13 = _mm256_loadu_ps(&weights[(n + 6)][(c + 0)]); // latency = 1
      __mv_vop15 = _mm256_loadu_ps(&weights[(n + 7)][(c + 0)]); // latency = 1
      __mv_accm0 =
          _mm256_fmadd_ps(__mv_vop0, __mv_vop1, __mv_accm0); // latency = 5
      __mv_accm1 =
          _mm256_fmadd_ps(__mv_vop3, __mv_vop1, __mv_accm1); // latency = 5
      __mv_accm2 =
          _mm256_fmadd_ps(__mv_vop5, __mv_vop1, __mv_accm2); // latency = 5
      __mv_accm3 =
          _mm256_fmadd_ps(__mv_vop7, __mv_vop1, __mv_accm3); // latency = 5
      __mv_accm4 =
          _mm256_fmadd_ps(__mv_vop9, __mv_vop1, __mv_accm4); // latency = 5
      __mv_accm5 =
          _mm256_fmadd_ps(__mv_vop11, __mv_vop1, __mv_accm5); // latency = 5
      __mv_accm6 =
          _mm256_fmadd_ps(__mv_vop13, __mv_vop1, __mv_accm6); // latency = 5
      __mv_accm7 =
          _mm256_fmadd_ps(__mv_vop15, __mv_vop1, __mv_accm7); // latency = 5
    ...
    top[(n + 0)] = __mv_arr0[0];                               // latency = 1
    top[(n + 1)] = __mv_arr0[1];                               // latency = 1
    top[(n + 2)] = __mv_arr0[2];                               // latency = 1
    top[(n + 3)] = __mv_arr0[3];                               // latency = 1
    top[(n + 4)] = __mv_arr0[4];                               // latency = 1
    top[(n + 5)] = __mv_arr0[5];                               // latency = 1
    top[(n + 6)] = __mv_arr0[6];                               // latency = 1
    top[(n + 7)] = __mv_arr0[7];                               // latency = 1
