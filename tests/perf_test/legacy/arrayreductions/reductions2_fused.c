    ...
    for (t = 0; t < TSTEPS; ++t) {
        ...
        for (i = 0; i < _PB_N; i+=4) {
            ...
            for (j = 0; j < _PB_N; j+=4) {
                ...
                vop1 = _mm256_load_pd(&A[i + 0][j + 0]);         // cost = 1
                ...
                _mm256_maskstore_pd(&x[i + 0], _mm256_set_epi64x(0, 0, 0, 0xffffffffffffffff),
                        vop2);                       // cost = 1

                vop1 = _mm256_load_pd(&A[i + 1][j + 0]);         // cost = 1
                ymm0 = _mm256_permute_pd(vop1, 0x05);            // cost = 1
                ymm1 = _mm256_add_pd(vop1, ymm0);                // cost = 1
                ymm2 = _mm256_permute2f128_pd(ymm1, ymm1, 0x01); // cost = 1
                ymm3 = _mm256_add_pd(ymm2, ymm1);                // cost = 1
                ...
                vop2 = _mm256_add_pd(ymm4, ymm3);                // cost = 1
                _mm256_maskstore_pd(&x[i + 1], _mm256_set_epi64x(0, 0, 0, 0xffffffffffffffff),
                        vop2);                       // cost = 1

                vop1 = _mm256_load_pd(&A[i + 2][j + 0]);         // cost = 1
                ymm0 = _mm256_permute_pd(vop1, 0x05);            // cost = 1
                ymm1 = _mm256_add_pd(vop1, ymm0);                // cost = 1
                ymm2 = _mm256_permute2f128_pd(ymm1, ymm1, 0x01); // cost = 1
                ymm3 = _mm256_add_pd(ymm2, ymm1);                // cost = 1
                ...
                vop2 = _mm256_add_pd(ymm4, ymm3);                // cost = 1
                _mm256_maskstore_pd(&x[i + 2], _mm256_set_epi64x(0, 0, 0, 0xffffffffffffffff),
                        vop2);                       // cost = 1

                vop1 = _mm256_load_pd(&A[i + 3][j + 0]);         // cost = 1
                ymm0 = _mm256_permute_pd(vop1, 0x05);            // cost = 1
                ymm1 = _mm256_add_pd(vop1, ymm0);                // cost = 1
                ymm2 = _mm256_permute2f128_pd(ymm1, ymm1, 0x01); // cost = 1
                ymm3 = _mm256_add_pd(ymm2, ymm1);                // cost = 1
                ...
                vop2 = _mm256_add_pd(ymm4, ymm3);                // cost = 1
                _mm256_maskstore_pd(&x[i + 3], _mm256_set_epi64x(0, 0, 0, 0xffffffffffffffff),
                        vop2);                       // cost = 1
                // statement replaced: x[i] = x[i] + A[i][j];
                vop0 = _mm256_load_pd(&y[i + 0]);    // cost = 1
                vop1 = _mm256_load_pd(&B[i + 0][j + 0]);         // cost = 1
                ymm0 = _mm256_permute_pd(vop1, 0x05);            // cost = 1
                ymm1 = _mm256_add_pd(vop1, ymm0);                // cost = 1
                ymm2 = _mm256_permute2f128_pd(ymm1, ymm1, 0x01); // cost = 1
                ymm3 = _mm256_add_pd(ymm2, ymm1);                // cost = 1
                ymm4 = _mm256_permute4x64_pd(vop0, 0x00);
                vop2 = _mm256_add_pd(ymm4, ymm3);                // cost = 1
                _mm256_maskstore_pd(&y[i + 0], _mm256_set_epi64x(0, 0, 0, 0xffffffffffffffff),
                        vop2);                       // cost = 1

                vop1 = _mm256_load_pd(&B[i + 1][j + 0]);         // cost = 1
                ymm0 = _mm256_permute_pd(vop1, 0x05);            // cost = 1
                ymm1 = _mm256_add_pd(vop1, ymm0);                // cost = 1
                ymm2 = _mm256_permute2f128_pd(ymm1, ymm1, 0x01); // cost = 1
                ymm3 = _mm256_add_pd(ymm2, ymm1);                // cost = 1
                ymm4 = _mm256_permute4x64_pd(vop0, 0x55);
                vop2 = _mm256_add_pd(ymm4, ymm3);                // cost = 1
                _mm256_maskstore_pd(&y[i + 1], _mm256_set_epi64x(0, 0, 0, 0xffffffffffffffff),
                        vop2);                       // cost = 1

                vop1 = _mm256_load_pd(&B[i + 2][j + 0]);         // cost = 1
                ymm0 = _mm256_permute_pd(vop1, 0x05);            // cost = 1
                ymm1 = _mm256_add_pd(vop1, ymm0);                // cost = 1
                ymm2 = _mm256_permute2f128_pd(ymm1, ymm1, 0x01); // cost = 1
                ymm3 = _mm256_add_pd(ymm2, ymm1);                // cost = 1
                ymm4 = _mm256_permute4x64_pd(vop0, 0xaa);
                vop2 = _mm256_add_pd(ymm4, ymm3);                // cost = 1
                _mm256_maskstore_pd(&y[i + 2], _mm256_set_epi64x(0, 0, 0, 0xffffffffffffffff),
                        vop2);                       // cost = 1

                vop1 = _mm256_load_pd(&B[i + 3][j + 0]);         // cost = 1
                ymm0 = _mm256_permute_pd(vop1, 0x05);            // cost = 1
                ymm1 = _mm256_add_pd(vop1, ymm0);                // cost = 1
                ymm2 = _mm256_permute2f128_pd(ymm1, ymm1, 0x01); // cost = 1
                ymm3 = _mm256_add_pd(ymm2, ymm1);                // cost = 1
                ymm4 = _mm256_permute4x64_pd(vop0, 0xff);
                vop2 = _mm256_add_pd(ymm4, ymm3);                // cost = 1
                _mm256_maskstore_pd(&y[i + 3], _mm256_set_epi64x(0, 0, 0, 0xffffffffffffffff),
                        vop2);                       // cost = 1
                // statement replaced: y[i] = y[i] + B[i][j];
            }
        }
    }
#pragma endmacveth
